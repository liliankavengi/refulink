...
export default function VaultDepositSuccessScreen() {
  const [showDetails, setShowDetails] = useState(false);
  const navigation = useNavigation<any>();
  const route = useRoute<RouteProp<RouteParams, "VaultDepositSuccess">>();
  const { amount } = route.params || { amount: "0" };

  const depositAmount = parseFloat(amount || "0");
  const usdcAmount = depositAmount * 0.0078; // Mock conversion rate
  const transactionId = `VD-${Date.now().toString(36).toUpperCase()}`;
        ...
        <View style={styles.content}>
          ...
          <Animated.View style={[
            ...
            <Text style={styles.successSubtitle}>
              KES {depositAmount.toLocaleString()} deposited to your vault
            </Text>
            
            <View style={styles.apyBadge}>
              <IconTrendingUp size={16} />
              <Text style={styles.apyText}>Now earning 4.5% APY</Text>
            </View>
          </Animated.View>
          ...
          <Animated.View style={[
            ...
            >
              ...
              <View style={styles.detailRow}>
                <View style={styles.detailLeft}>
                  <IconVault size={14} />
                  <Text style={styles.detailLabel}>USDC Received</Text>
                </View>
                <Text style={styles.detailValue}>
              ...
              {showDetails && (
                <View style={styles.expandedDetails}>
                  ...
                  <View style={styles.detailRow}>
                    ...
                    <Text style={styles.detailValue}>1 KES = 0.0078 USDC</Text>
                  </View>
                  ...
                  <View style={styles.detailRow}>
                    <Text style={styles.detailLabel}>APY Rate</Text>
                    <Text style={styles.apyValue}>4.5%</Text>
                  </View>
          ...
          <Animated.View style={[
            ...
            >
              ...
              <Text style={styles.infoText}>
                Your funds are now secured on the Stellar blockchain as USDC and earning passive yield through Soroban smart contracts.
              </Text>
            </ExpoLinearGradient>
          </Animated.View>
