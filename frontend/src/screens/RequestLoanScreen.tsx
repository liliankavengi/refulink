...
import { requestLoan } from "../services/trustService";
  ...
  const handleBiometricConfirm = async () => {
    try {
      ...
      if (result.success) {
        ...
        try {
          // Call the real loan API
          const loanResult = await requestLoan(amount);
          ...
          const msg =
            ...
            error?.message ||
            "Loan request failed. Please try again.";
